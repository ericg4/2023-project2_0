...
public class PPRamseteCommand extends CommandBase {
    ...
    public boolean isFinished() {
        return Conversions.getSquaredDistance(poseSupplier.get().getTranslation(),
                trajectory.getEndState().poseMeters.getTranslation()) < trajConstants.autoToleranceSquared
                && this.timer.hasElapsed(transformedTrajectory.getTotalTimeSeconds());
    }
